export type SettingsTab = 'releaseNotes' | 'team' | 'serverSettings' | 'translations' | 'audit';
...
export const SETTINGS_TABS: SettingsTab[] = ['releaseNotes', 'team', 'serverSettings', 'translations', 'audit'];
